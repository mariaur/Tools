...
Test-ServiceFabricClusterManifest -ClusterManifestPath "$clusterManifest"

Write-Host
Write-Host "INFO: Creating cluster node configuration ..."
New-ServiceFabricNodeConfiguration -RunFabricHostServiceAsManual -ClusterManifestPath $clusterManifest -FabricDataRoot $fabricDataRoot -FabricLogRoot $fabricLogRoot -Verbose 
